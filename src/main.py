...
device_type_id = mongo_logger.ensure_device_type("device 1", ["ICMP"])
...
kibble = Kibble(monitors=[monitor], loggers=[screen_logger, mongo_logger], alerters=[screen_alert], device_type_id=device_type_id)
kibble.run()
