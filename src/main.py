...
try:
    kibble = Kibble(client=mongo_client, monitors=[icmp_monitor, scpi_monitor, daemon_monitor], alerters=[screen_alert], detector=detector, default_device_type=("device 1", ["ICMP"]))
except Exception as e:
